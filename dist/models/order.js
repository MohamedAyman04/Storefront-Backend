...
var AppOrder = /** @class */ (function () {
    function AppOrder() {
    }
    // index method to return everything
    AppOrder.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("can't do that ".concat(error_1));
    ...
    AppOrder.prototype.show = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("can't do that ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    AppOrder.prototype.create = function (Order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("can't do that ".concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    AppOrder.prototype.addProduct = function (quantity, order_id, product_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("can't do that ".concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    AppOrder.prototype.update = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    AppOrder.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, order, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("can't do that ".concat(error_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
