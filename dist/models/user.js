...
var AppUser = /** @class */ (function () {
    ...
    AppUser.prototype.index = function () {
    ...
    AppUser.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    AppUser.prototype.create = function (User) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, pass, result, user, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        pass = bcrypt_1["default"].hashSync(User.password + pepper, parseInt(process.env.SALT_ROUNDS));
                        return [4 /*yield*/, conn.query(sql, [
                                User.first_name,
                                User.last_name,
                                pass,
    ...
    AppUser.prototype.authenticate = function (User) {
        return __awaiter(this, void 0, void 0, function () {
