...
var order = new order_1.AppOrder();
...
var show = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, order.show(req.params.id)];
            case 1:
                tar = _a.sent();
                console.log(tar);
                res.json(tar);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, order.create(or)];
            case 1:
                cer = _a.sent();
                console.log(cer);
                res.json(cer);
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var quantity, order_id, product_id, pro, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, order.addProduct(quantity, order_id, product_id)];
            case 1:
                pro = _a.sent();
                console.log(pro);
                res.json(pro);
